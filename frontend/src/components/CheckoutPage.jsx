...
<<<<<<< HEAD
                customer: {
                    ...
                    // Actually backend create_order uses customer_data.get('address'). 
                    // Let's rely on backend extracting province if I modify create_order or just save it.
                    // Wait, I updated Order model but NOT the create_order logic in views.py to extract province!
                    // I need to update views.py create_order to save shipping_province.
                    // Let's modify payload to include shipping_province inside customer object, and update View later or now.
                },
                paymentMethod: ['QR', 'Bank'].includes(paymentMethod) ? 'Transfer' : paymentMethod
            };
            
            // NOTE: I missed updating create_order in views.py to save shipping_province from request.data['customer']['province']
            // I will fix views.py in next step. For now frontend sends it.
=======
                customer: formData,
                paymentMethod: ['QR', 'Bank'].includes(paymentMethod) ? 'Transfer' : paymentMethod
            };
