...
useEffect(() => {
    ...
    // fetch categories และ products ตามเดิม...
...
<<<<<<< HEAD
                           ...
                           {/* ✅ ป้ายสถานะสต็อก */}
                           {product.stock === 0 ? (
                                <span className="bg-gray-800 text-white text-[10px] px-3 py-1.5 rounded-full font-bold uppercase shadow-sm">
                                    ⚫ สินค้าหมด
                                </span>
                           ) : product.stock < 5 ? (
                                <span className="bg-red-500 text-white text-[10px] px-3 py-1.5 rounded-full font-bold uppercase shadow-sm animate-pulse">
...
<<<<<<< HEAD
                              ...
                              <button 
                                  ...
                                  className={`flex-1 md:flex-none px-8 py-3 rounded-full font-bold shadow-md transition-all active:scale-95 ${
                                      product.stock === 0 
                                      ? 'bg-gray-300 text-gray-500 cursor-not-allowed' 
                                      : 'bg-primary hover:bg-[#234236] text-white'
                                  }`}
                              >
