      ...
      <div className="max-w-md w-full bg-white p-10 rounded-[2.5rem] shadow-xl border border-white relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4 relative z-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-xs font-bold text-gray-500 uppercase ml-2 mb-1 block">ชื่อจริง</label>
              <input
                type="text"
                name="first_name"
            ...
            <div>
              <label className="text-xs font-bold text-gray-500 uppercase ml-2 mb-1 block">นามสกุล</label>
              <input
                type="text"
                name="last_name"
